...
image::https://www.mulesoft.com/ext/solutions/draft/images/cim1.3/accel-cim-sales-order.png[alt="Sales Order Diagram",link="https://www.mulesoft.com/ext/solutions/draft/images/cim1.3/accel-cim-sales-order.png"]
