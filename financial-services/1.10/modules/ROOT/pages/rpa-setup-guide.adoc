...
* Install the latest version of MuleSoft xref:rpa-builder::install-and-configure.adoc[RPA Builder] and xref:rpa-bot::installation[RPA Bot] from the RPA Manager home page.
...
* xref:rpa-manager::processautomation-deploy#publish-automation-exchange[Publish the project to Anypoint Exchange as an invocable run configuration].
