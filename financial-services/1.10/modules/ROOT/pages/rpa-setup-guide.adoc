...
* Ensure the Anypoint Platform account that will be used has xref:rpa-home::automation-userrolesandpermissions-anypointrpapermissions.adoc[the RPA Automations Manager and RPA Bots Manager permissions].
