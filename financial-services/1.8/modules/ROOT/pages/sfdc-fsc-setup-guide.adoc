...
* The Apex Triggers AccountEventsPub, AccountAddressEventsPub, and HouseholdEventsPub filter records based on record type ID. A query is povided in the respective Apex trigger as a comment and it can be used to obtain the record type ID. 
