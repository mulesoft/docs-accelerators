...
|===
|image:bulb.png[Before You Begin icon, 20%, 20%]|
https://dev-docs-internal.kqa.msap.io/beta-accelerators/accelerators-home/getting-started[Getting Started with MuleSoft Accelerators] guide provides general information on getting started with the accelerator components. This includes instructions on setting up your local workstation for configuring and deploying the applications.
|===
