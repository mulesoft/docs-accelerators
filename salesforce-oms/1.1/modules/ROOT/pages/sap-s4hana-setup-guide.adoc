...
=== Confiigure Salesforce Order Management
...
After configuring the communication arrangements, add the customer by using the rule `Outbound Delivery` and the Determination Step Channel.
...
You must create a custom communication scenario by adding the CDS view as an inbound service. After you publish the communication scenario, create a communication arrangement using the custom communication scenario you just created. The communication arrangement includes the service URL that is used to retrieve the SD Document Flow.
