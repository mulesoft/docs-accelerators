...
The following use cases provided by the https://anypoint.mulesoft.com/exchange/org.mule.examples/mulesoft-accelerator-for-sap/minor/1.6/[MuleSoft Accelerator for SAP] are also leveraged by this accelerator:
