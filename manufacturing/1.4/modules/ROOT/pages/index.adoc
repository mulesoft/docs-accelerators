...
* https://anypoint.mulesoft.com/exchange/org.mule.examples/mulesoft-accelerator-for-manufacturing/minor/{mfg-version}/pages/qrc-zzh/Use%20case%201%20-%20Account%20and%20product%20and%20order%20sync/[Account and product and order sync^] — Streamline account forecasts by connecting critical account, product, and order data from your ERP to CRM. This example will show how to accomplish this using SAP S/4HANA and Salesforce Manufacturing Cloud.
