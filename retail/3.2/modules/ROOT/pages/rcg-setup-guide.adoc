...
* Salesforce Configuration: Addition of custom fields and enabling Person Accounts (details can be found https://help.salesforce.com/s/articleView?language=en_US&id=000328922&mode=1&type=1[here]) in addition to creating a push topic on Account object with appropriate filters.
