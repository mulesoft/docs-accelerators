...
* Salesforce Configuration: Addition of custom fields and enabling Person Accounts in addition to creating a push topic on Account object with appropriate filters.
