...
* https://anypoint.mulesoft.com/exchange/org.mule.examples/mulesoft-accelerator-for-retail/minor/{retail-version}/pages/Use%20case%206%20-%20POS%20integration/[POS Integration^] - The Point of Sale (POS) Integration use case enables retail developers to leverage pre-built integrations to connect order and loyalty data from POS systems to Salesforce Loyalty Management and Data Cloud.
