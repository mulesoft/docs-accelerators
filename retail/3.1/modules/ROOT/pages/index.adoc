...
* https://anypoint.mulesoft.com/exchange/0b4cad67-8f23-4ffe-a87f-ffd10a1f6873/mulesoft-accelerator-for-retail/minor/{retail-version}/pages/Use%20case%206%20-%20POS%20integration/[POS Integration^] - The Point of Sales integration use case enables retail developers to leverage pre-built integrations to connect order and loyalty data from POS Systems to Salesforce Loyalty Management and Data Cloud.
