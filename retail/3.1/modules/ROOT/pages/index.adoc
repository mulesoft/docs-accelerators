...
:page-aliases: 3.1@retail::rcg-assets.adoc
...
* https://anypoint.mulesoft.com/exchange/org.mule.examples/mulesoft-accelerator-for-retail/minor/{retail-version}/pages/fgh-fsy/Use%20case%205%20-%20Deliver%20relevancy%20with%20Data%20Cloud/[Deliver relevancy with CDP^] - The Deliver relevancy with CDP use case enables retail developers to combine customer profile data in a standardized format.

* https://anypoint.mulesoft.com/exchange/org.mule.examples/mulesoft-accelerator-for-retail/minor/{retail-version}/pages/bqs-g24/Use%20case%206%20-%20POS%20integration/[POS Integration^] - The Point of Sale (POS) Integration use case enables retail developers to leverage pre-built integrations to connect order and loyalty data from POS systems to Salesforce Loyalty Management and Data Cloud.
