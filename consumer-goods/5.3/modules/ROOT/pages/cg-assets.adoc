...
| RCG Pricing Data Synchronization Process API
| https://anypoint.mulesoft.com/exchange/org.mule.examples/rcg-price-sync-prc-api-spec[API Specification^]
| https://anypoint.mulesoft.com/exchange/org.mule.examples/rcg-price-sync-prc-api/[Implementation Template^]
...
| POS Event Listener
| https://anypoint.mulesoft.com/exchange/org.mule.examples/rcg-predictspring-event-listener/[Implementation Template^]
|===
