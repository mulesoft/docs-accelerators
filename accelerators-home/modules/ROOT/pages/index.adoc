...
.^|image:oms-icon.png[OMS,100%] .^| xref:salesforce-oms::index.adoc[MuleSoft Accelerator for Salesforce OMS] .^| Add EDI as a direct order intake channel to manage and service EDI orders across the full lifecycle.
