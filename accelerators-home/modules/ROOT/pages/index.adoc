...
.^|image:fs-icon.png[Financial Services,100%] .^| xref:1.7@financial-services::index.adoc[MuleSoft Accelerator for Financial Services^] .^| Simplifies customer 360 initiatives by unlocking both core banking and insurance platforms, systems of engagement (such as CRM and ITSM), Insuretechs, and FinTech data.
