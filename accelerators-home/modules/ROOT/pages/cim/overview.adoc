...
* The xref:usage-guide.adoc[Usage Guide] provides some helpful guidelines on how to use and interpret the model.
* xref:subject-areas.adoc[CIM Subject Areas]
* The xref:customizations.adoc[Model Customizations] page describes the customizations and extensions that have been made to the original Cloud Information Model for use by the MuleSoft Accelerators.
