...
Refer to the https://dev-docs-internal.kqa.msap.io/beta-accelerators/runtime-manager/secure-application-properties[MuleSoft documentation^] for more information.
