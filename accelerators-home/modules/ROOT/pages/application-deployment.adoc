...
[NOTE]
The template described previously is generic. Many accelerators provide their own version of the common resources project, which  contain a similar template specialized for that accelerator.
