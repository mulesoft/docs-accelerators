...
.2+|ExternalId |externalIdType |CORE_BANKING, CREDIT_CARD, DOCUSIGN, LOS, JIRA, OFBIZ, MDM, PIM, SAP_ECC, SAP_4HANA, SALESFORCE_B2C, SALESFORCE_CORE, SALESFORCE_FSC_BANKING, SALESFORCE_FSC_INSURANCE, SALESFORCE_FSC_WEALTH, SALESFORCE_MARKETING, SALESFORCE_MFG, SALESFORCE_SALES, SALESFORCE_SERVICE, SERVICENOW
