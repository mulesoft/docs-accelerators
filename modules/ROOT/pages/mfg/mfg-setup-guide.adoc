...
The Anypoint-MQ-Queues-Exchanges Postman collection in the https://www.anypoint.mulesoft.com/exchange/org.mule.examples/mfg-common-resources-src/[MFG Common Resources project^] will pre-create all MQ destinations required by the accelerator components.
