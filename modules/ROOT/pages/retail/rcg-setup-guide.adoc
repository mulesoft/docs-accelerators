...
Please refer to the xref:accelerators::common-services.adoc[Accelerators Common Services] documentation for more details on configuring optional components.
