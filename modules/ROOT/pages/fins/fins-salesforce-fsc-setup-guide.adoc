...
An Apex class called `CustomFieldUtility` can be used to create custom fields programmatically. The source for this class can be found in the https://anypoint.mulesoft.com/exchange/8f5e182d-2f4a-4ac0-a319-28f660de099c/fins-common-resources-src[Common Resources project]. Download this project and follow the steps below.
...
The following PushTopics must be created in order to capture updates from Salesforce. The Apex scripts to create these PushTopics are located in the https://anypoint.mulesoft.com/exchange/8f5e182d-2f4a-4ac0-a319-28f660de099c/fins-salesforce-topic-listener/[Salesforce Topic Listener integration template].
...
Download the https://anypoint.mulesoft.com/exchange/8f5e182d-2f4a-4ac0-a319-28f660de099c/fins-common-resources-src[Common Resources project] for a sample `settings.xml` file that can be used as a starting point.
