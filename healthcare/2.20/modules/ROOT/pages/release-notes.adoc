...
This release extends the solution provided for https://anypoint.mulesoft.com/exchange/0b4cad67-8f23-4ffe-a87f-ffd10a1f6873/mulesoft-accelerator-for-healthcare/minor/{hls-version}/pages/Use%20case%201%20-%20Patient%20360/[Patient 360 use case] to allow customers to discover and deploy from Salesforce using MuleSoft Direct for Health Cloud.

* Patient Summary - EMR Integration | https://anypoint.mulesoft.com/exchange/0b4cad67-8f23-4ffe-a87f-ffd10a1f6873/hls-hc-fhir-r4-sync-prc-api-impl[Application] 
* Event-based ingestion into Health Cloud | https://anypoint.mulesoft.com/exchange/0b4cad67-8f23-4ffe-a87f-ffd10a1f6873/hls-hl7v2-events-mgmt-listener-impl[Application] 
* Enhanced FHIR R4 RAML libraries and specifications to leverage new version of AMF parser to better align with industry standard
