...
* Select Enable. After person accounts are enabled, assign them to profiles. See https://help.salesforce.com/s/articleView?language=en_US&id=sf.admin_person_account_overview.htm[Set Up Person Accounts to Represent Health Cloud Members and Patients^] for the detailed explanation of representing patients in Health Cloud.
...
Please refer to the https://help.salesforce.com/s/articleView?language=en_US&id=connected_app_create.htm&type=5[instructions^] in Salesforce docs to create a connected app.
...
For additional details on HL7 Connector, please refer to the https://docs.mulesoft.com/hl7-connector/latest/[documentation^].
