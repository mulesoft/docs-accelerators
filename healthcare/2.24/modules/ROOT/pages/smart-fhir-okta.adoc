...
** Out-of-the-box https://docs.mulesoft.com/gateway/latest/policies-included-openid-token-enforcement[OpenID Connect token enforcement policy^]
...
** Out-of-the-box https://docs.mulesoft.com/gateway/latest/policies-included-cors[cross origin resource sharing (CORS) policy^] enables cross origin data exchange.
