...
* Select Enable. After person accounts are enabled, assign them to profiles. Please refer to the attached https://help.salesforce.com/s/articleView?language=en_US&id=sf.admin_person_account_overview.htm[document^] for the detailed explanation of representing patients in Health Cloud.
