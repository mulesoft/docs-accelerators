...
The following updates are includes in this release:

* Launched a new version of the FHIR JSON-to-RAML autogenerator to improve representation of key FHIR concepts in generated RAML specification, including support for descriptions and notes, constraining cardinality, element flags, linking to relevant value sets, extensions, and slicing.
