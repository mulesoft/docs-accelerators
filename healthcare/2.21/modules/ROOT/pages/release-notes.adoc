...
* Launched a new version of the FHIR RAML autogenerator to improve representation of key FHIR concepts in generated RAML specification, including support for descriptions and notes, constraining cardinality, element flags, linking to relevant value sets, extensions, and slicing.
