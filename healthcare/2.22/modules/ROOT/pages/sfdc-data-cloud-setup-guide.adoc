...
Refer to the https://docs.mulesoft.com/salesforce-cdp-connector/1.1/true[CDP Connector documentation] for additional details on configuration and available operations.
